...
return [
     ...
     */
    'Session' => [
        'defaults' => 'cake', // Use cake defaults which are more reliable
        'cookie' => 'CAKEPHP',
        'cookiePath' => '/',
        'timeout' => 120, // 2 hours in minutes  
        'ini' => [
            'session.cookie_lifetime' => 7200, // 2 hours in seconds
            'session.gc_maxlifetime' => 7200,
            'session.cookie_httponly' => true,
            'session.cookie_secure' => false, // Set to true in production with HTTPS
     ...
     * ## Options
     *
     *  - `baseUrl` - Your Okta domain URL (e.g., https://your-domain.okta.com)
     *  - `clientId` - Your Okta application client ID
     *  - `clientSecret` - Your Okta application client secret (not needed with PKCE)
     */
    'Okta' => [
        'baseUrl' => env('OKTA_BASE_URL', 'https://your-okta-domain.okta.com'),
        'clientId' => env('OKTA_CLIENT_ID', 'your-client-id'),
        // clientSecret not needed when using PKCE
    ],
     ...
     */
    'S3' => [
        'key' => env('AWS_ACCESS_KEY_ID', 'your-aws-access-key'),
        'secret' => env('AWS_SECRET_ACCESS_KEY', 'your-aws-secret-key'),
        'region' => env('AWS_S3_REGION', 'us-east-1'),
        'bucket' => env('AWS_S3_BUCKET', 'meg-documents'),
    ],
];
