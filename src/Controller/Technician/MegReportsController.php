 ...
 * 
 * Note: Technicians can only download PPT reports, not view/edit slides
 *
...
class MegReportsController extends AppController
{
     ...
     * Technicians have read-only access to download PPT reports
     *
    ...
    public function downloadPpt($reportId = null)
    {
        ...
        // Technicians can access all reports (permissive access model)
