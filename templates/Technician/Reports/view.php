                ...
                <div class="card-body bg-white">
                    ...
                    <div class="small">
                        <div class="d-flex align-items-center mb-2">
                            <div class="me-2">
                                <i class="fas fa-circle text-<?= $report->status === 'pending' ? 'primary' : 'success' ?>"></i>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <div class="me-2">
                                <i class="fas fa-circle text-<?= $report->status === 'reviewed' ? 'primary' : ($report->status === 'approved' ? 'success' : 'muted') ?>"></i>
                            </div>
