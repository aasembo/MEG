                ...
                <div class="card-header bg-gradient" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <div class="d-flex align-items-center justify-content-between text-white">
                        <div class="d-flex align-items-center">
                            ...
                            <h6 class="mb-0 fw-semibold">AI-Powered Recommendations</h6>
                        </div>
                        <small class="opacity-75">Based on patient symptoms</small>
                    </div>
                </div>
                <div class="card-body bg-light">
                    ...
                    <div class="alert alert-info border-0 mb-3" style="background-color: #e3f2fd;">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="small">
                                <strong>How to use AI recommendations:</strong>
                                Review the suggestions below and click "Apply" to automatically fill the corresponding form fields. 
                                You can apply individual recommendations or use "Apply All" for complete automation.
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <small class="text-muted fw-semibold">RECOMMENDED PROCEDURES</small>
                                            <div class="fw-bold text-dark">Select which procedures to apply</div>
                                        </div>
                                    </div>
                                    <div class="btn-group" role="group">
                                        <button type="button" class="btn btn-outline-success btn-sm" id="applySelectedRecommendations">
                                            <i class="fas fa-check me-1"></i>Apply Selected
                                        </button>
                                        <button type="button" class="btn btn-success btn-sm" id="applyAllRecommendations">
                                ...
                                <div class="alert alert-warning border-0 mt-3 mb-0" style="background-color: #fff3cd;">
                                    <small class="text-warning-emphasis">
                                        <i class="fas fa-info-circle me-1"></i>
                                        These procedures will be automatically selected in the procedures section below when you click "Apply".
                                    </small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-center mt-4">
                        <button type="button" class="btn btn-lg btn-gradient text-white px-4" id="applyAllMasterRecommendations" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                            <i class="fas fa-robot me-2"></i>Apply All AI Recommendations
                            <small class="d-block mt-1 opacity-75">Department + Sedation + Priority + Procedures</small>
                        </button>
                    </div>
                </div>
            </div>
                            ...
                            <?php if (!empty($examsProcedures)): ?>
                                <div class="p-3">
                                    <div class="row g-2" id="proceduresList">
                                        <?php 
                                        foreach ($examsProcedures as $examProc): 
                                            // Ensure we have an object before trying to access properties
                                            if (!is_object($examProc)) {
                                                continue;
                                            }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (applyAllBtn) {
        applyAllBtn.addEventListener('click', function() {
            ...
            updateSelectedCount();
            showToast('All recommended procedures applied successfully', 'success');
        });
    }
