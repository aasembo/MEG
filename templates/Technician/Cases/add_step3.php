        ...
        <div class="col-lg-10">
            ...
            <div class="alert alert-info border-0 shadow-sm">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h6 class="mb-1">Ready to Create</h6>
                        <div class="small mb-0">
                            Please review all information above. Once you click "Create Case", the new case will be added to the system and available for assignment.
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('<?php echo  $this->Url->build(['action' => 'saveStep3']) ?>', {
                method: 'POST',
                headers: {
            ...
            if (result.success) {
                ...
                alertContainer.innerHTML = `
                    <div class="alert alert-success border-0" role="alert">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <strong>Success!</strong> Case has been created successfully. Redirecting to case view...
                            </div>
                        </div>
                    </div>
                `;
                ...
                errorHtml += '<h6 class="mb-1">Creation Failed</h6>';
            ...
            alertContainer.innerHTML = `
                <div class="alert alert-danger border-0" role="alert">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <strong>Network Error:</strong> An error occurred while creating the case. Please check your connection and try again.
                        </div>
                    </div>
                </div>
            `;
