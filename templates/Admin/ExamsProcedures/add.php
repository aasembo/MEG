 ...
 */
?>
<div class="exams-procedures add content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3><i class="fas fa-plus me-2"></i><?php echo __('Add Exam-Procedure Association') ?></h3>
        <?php echo $this->Html->link(__('List Associations'), ['action' => 'index'], ['class' => 'btn btn-outline-primary']) ?>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <div class="d-flex gap-2">
                <?php echo $this->Form->button(__('Save Association'), ['class' => 'btn btn-primary']) ?>
