...
<div class="container-fluid">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-dark text-warning py-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-1">
                        <i class="fas fa-edit me-2"></i>Edit Sedation Level
                    </h4>
                    <p class="mb-0 text-light">Update sedation level information and settings</p>
                </div>
                <div class="btn-group">
                    <?php echo  $this->Html->link('<i class="fas fa-eye me-1"></i>View', 
                        ['action' => 'view', $sedation->id], 
                        ['class' => 'btn btn-outline-warning btn-sm', 'escape' => false]) ?>
                    <?php echo  $this->Html->link('<i class="fas fa-list me-1"></i>List', 
                        ['action' => 'index'], 
                        ['class' => 'btn btn-outline-light btn-sm', 'escape' => false]) ?>
                    <?php echo  $this->Form->postLink('<i class="fas fa-trash me-1"></i>Delete',
                        ['action' => 'delete', $sedation->id],
                        [
                            'confirm' => 'Are you sure you want to delete this sedation level?',
    ...
    <div class="row">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 justify-content-end mt-4">
                        <?php echo  $this->Form->button('<i class="fas fa-save me-1"></i>Update Sedation Level', [
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-light">
                    <h6 class="mb-0 text-dark"><i class="fas fa-info-circle me-2"></i>Edit Guidelines</h6>
                </div>
                <div class="card-body">
                    <div class="small text-muted">
                        <div class="mb-3">
                            <strong class="text-dark d-block mb-1">Sedation Level</strong>
                            Use standard terminology that follows institutional protocols.
                        </div>
                        <div class="mb-3">
                            <strong class="text-dark d-block mb-1">Risk Assessment</strong>
                            Update risk category based on current safety guidelines and patient monitoring requirements.
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="alert alert-warning py-2 px-3 small mb-0">
                            ...
                            Changes will affect all related procedures and patient care protocols.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-light">
                    <h6 class="mb-0 text-dark"><i class="fas fa-list-ul me-2"></i>Standard Sedation Levels</h6>
                </div>
                <div class="card-body">
                    <div class="small text-muted">
                        <div class="mb-2">
