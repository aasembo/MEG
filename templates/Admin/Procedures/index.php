 ...
 */
?>
<?php $this->assign('title', 'Procedures Management'); ?>
...
<div class="container-fluid px-4 py-4">
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="mb-0 text-white-50">
                        <i class="fas fa-hospital me-2"></i>Medical Procedures & Services
                    </p>
                </div>
        ...
        <div class="col-md-3">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body text-center">
                    <i class="fas fa-procedures text-warning fs-1 mb-3"></i>
                    <h3 class="text-warning mb-2"><?php echo $procedures->count() ?></h3>
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h5 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-filter me-2 text-warning"></i>Search & Filter Procedures
                    </h5>
                </div>
                <div class="col-md-4 text-md-end">
                    ...
                    <?php else: ?>
                        <small class="text-muted">
                            ...
                            <?php echo $procedures->count() ?> procedure(s) found
                        </small>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <?php echo $this->Form->create(null, ['type' => 'get', 'class' => 'row g-3']) ?>
                <div class="col-md-10">
                    <label class="form-label fw-semibold">
                        <i class="fas fa-search me-1 text-warning"></i>Search Procedures
                    </label>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <span class="badge bg-warning text-dark fs-6 px-3 py-2">
                ...
                <?php echo $this->Paginator->counter(__('{{count}} Procedures Found')) ?>
            </span>
            <?php if ($this->request->getQuery('search')): ?>
                    ...
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="border-0 fw-semibold text-uppercase small" style="width: 250px;">
                                <?php echo $this->Paginator->sort('Procedures.name', 'Procedure Name', [
                                    'class' => 'text-decoration-none text-dark'
                                ]) ?>
                            </th>
                            <th class="border-0 fw-semibold text-uppercase small" style="width: 120px;">
                                <?php echo $this->Paginator->sort('Procedures.type', 'Type', [
                                    'class' => 'text-decoration-none text-dark'
                                ]) ?>
                            </th>
                            ...
                            <th class="border-0 fw-semibold text-uppercase small" style="width: 100px;">
                                <?php echo $this->Paginator->sort('Procedures.risk_level', 'Risk', [
                                    'class' => 'text-decoration-none text-dark'
                                ]) ?>
                            </th>
                            <th class="border-0 fw-semibold text-uppercase small" style="width: 100px;">
                                <?php echo $this->Paginator->sort('Procedures.cost', 'Cost', [
                                    'class' => 'text-decoration-none text-dark'
                                ]) ?>
                            </th>
                            <th class="border-0 fw-semibold text-uppercase small" style="width: 120px;">
                                <?php echo $this->Paginator->sort('Procedures.created', 'Created', [
                                    'class' => 'text-decoration-none text-dark'
                                ]) ?>
                            </th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div>
                                        <?php echo $this->Html->link(
                                            '<span class="fw-semibold">' . h($procedure->name) . '</span>',
                                            ['action' => 'view', $procedure->id],
                                            ['escape' => false, 'class' => 'text-decoration-none text-dark']
                                        ); ?>
                                        <div class="text-muted small">
                                            <i class="fas fa-hashtag me-1"></i>Procedure ID: <?php echo $procedure->id ?>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <?php if (!empty($procedure->type)): ?>
                                    <span class="badge bg-info bg-opacity-10 text-info"><?php echo h($procedure->type) ?></span>
                                <?php else: ?>
                            ...
                            <td>
                                <?php if ($procedure->hasValue('department')): ?>
                                    <span class="text-dark"><?php echo h($procedure->department->name) ?></span>
                                <?php else: ?>
                            ...
                            <td>
                                <?php if (!empty($procedure->risk_level)): ?>
                                    <span class="badge bg-<?php echo $procedure->risk_level === 'high' ? 'danger' : ($procedure->risk_level === 'medium' ? 'warning text-dark' : 'success') ?>">
                                        <i class="fas fa-shield-alt me-1"></i><?php echo ucfirst(h($procedure->risk_level)) ?>
                                    </span>
                                <?php else: ?>
                                    <span class="text-muted">-</span>
                                <?php endif; ?>
                            ...
                            <td>
                                <?php if (!empty($procedure->cost)): ?>
                                    <span class="text-success fw-bold">
                                        <i class="fas fa-dollar-sign me-1"></i><?php echo number_format($procedure->cost, 2) ?>
                                    </span>
                                <?php else: ?>
                                    <span class="text-muted">-</span>
                                <?php endif; ?>
                            ...
                            <td>
                                <div class="text-dark"><?php echo h($procedure->created->format('M j, Y')) ?></div>
                                <small class="text-muted"><?php echo h($procedure->created->format('g:i A')) ?></small>
                            </td>
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    ...
                                    <?php echo $this->Form->postLink(
                                        ...
                                        [
                                            'confirm' => __('Are you sure you want to delete "{0}"?', $procedure->name),
        ...
        <div class="card-footer bg-light">
            <div class="row align-items-center g-3">
                <div class="col-md-6 col-12">
                    <div class="text-muted small">
                        <i class="fas fa-info-circle me-1"></i>
                        <?php echo $this->Paginator->counter('Showing {{start}} to {{end}} of {{count}} procedures'); ?>
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <nav aria-label="Procedures pagination">
    ...
    <div class="card border-0 shadow">
        <div class="card-body text-center py-5">
            <div class="mb-4">
                <i class="fas fa-procedures fa-4x text-warning mb-3"></i>
                <h4 class="text-dark mb-2">No Procedures Found</h4>
                <p class="text-muted mb-4">
                    <?php if ($this->request->getQuery('search')): ?>
                        No procedures match your search criteria. Try adjusting your search terms.
                    <?php else: ?>
                        You haven't created any procedures yet. Procedures define the specific medical services offered by your facility.
                    <?php endif; ?>
                </p>
            </div>
            <div>
            ...
            <div class="mt-3">
                <small class="text-muted">
                    <i class="fas fa-info-circle me-1"></i>
                    Examples: Blood Test, X-Ray Imaging, MRI Scan, Surgery Prep, Colonoscopy
                </small>
            </div>
        </div>
    </div>
