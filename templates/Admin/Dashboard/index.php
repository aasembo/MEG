        ...
        <div class="col-12">
            <div class="alert alert-primary border-0 shadow-sm" role="alert">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="alert-heading mb-1">Welcome to <?php echo h($currentHospital->name) ?> Admin Panel</h4>
                        <p class="mb-0">Manage your hospital's users, staff, and operations from this dashboard.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <div class="small text-muted">Current Hospital</div>
                            <div class="h6 mb-0"><?php echo h($currentHospital->name) ?></div>
                            <div class="small text-success">
