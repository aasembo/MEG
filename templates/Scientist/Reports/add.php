 ...
 * @var \App\Model\Entity\Report|null $technicianReport
 * @var string $reportContent
 */
$isEdit = !$report->isNew();
$this->assign('title', $isEdit ? 'Edit Scientific Report' : 'Create Scientific Report');
?>
...
<div class="container-fluid px-4 py-4">
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="mb-2 fw-bold">
                        <i class="fas fa-file-medical-alt me-2"></i><?php echo  $isEdit ? 'Edit Scientific Report' : 'Create Scientific Report' ?>
                    </h2>
                    <?php if (isset($case)): ?>
                    <p class="mb-0">
                    ...
                    <?php if (isset($technicianReport)): ?>
                    <small class="opacity-75">
                        <i class="fas fa-info-circle me-1"></i>
                        Based on Technician Report #<?php echo  h($technicianReport->id) ?> 
                        (Created: <?php echo  h($technicianReport->created->format('M j, Y')) ?>)
                    </small>
                    <?php endif; ?>
                    <?php endif; ?>
                </div>
    ...
    <!-- Workflow Context (if creating from technician report) -->
    <?php if (isset($technicianReport) && !$isEdit): ?>
    <div class="card border-0 shadow mb-4">
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h6 class="mb-0 fw-bold text-dark">
                        ...
                        Workflow Context: Creating Scientist Report
                    </h6>
                    <p class="mb-0 small text-muted mt-1">
                        This report is being created as part of the scientific review process. 
                        The technician's initial analysis has been loaded as the starting point.
                    </p>
                </div>
                <div class="col-md-4 text-md-end">
                    <div class="d-flex align-items-center justify-content-end">
                        <span class="badge bg-info me-2">
                            <i class="fas fa-user-cog me-1"></i>Technician
                        </span>
                        <i class="fas fa-arrow-right text-muted me-2"></i>
                        <span class="badge bg-warning">
                            <i class="fas fa-user-graduate me-1"></i>Scientist
                        </span>
                        <i class="fas fa-arrow-right text-muted ms-2 me-2"></i>
    ...
    <div class="alert alert-info border-0 shadow-sm mb-4">
        <div class="d-flex align-items-center">
            ...
            <div class="flex-grow-1 ms-3">
                ...
                <p class="mb-2">
                    <strong>Only one scientist can be assigned to each case.</strong> As the assigned scientist, you can create and edit the scientist report for this case. 
                    You can view technician reports and create reports for doctors as part of the workflow hierarchy.
                </p>
                <small class="text-muted">
                    <i class="fas fa-user-graduate me-1"></i>
                    You are responsible for the scientific analysis and review of this case.
                </small>
            </div>
        </div>
    </div>
    ...
    <div class="row">
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless table-sm">
                                <tr>
                                    ...
                                    <td><span class="badge bg-success"><?php echo  h($case->id) ?></span></td>
                                </tr>
                                <tr>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-light py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-bold text-dark">
                            <i class="fas fa-edit me-2 text-success"></i>MEG Report Content
                        </h5>
            ...
            <div class="card border-0 shadow mb-4">
                ...
                <div class="card-body bg-white">
                    <div class="alert alert-warning border-0 mb-3">
                        ...
                        <strong>Internal Use Only:</strong> These notes are for scientist reference and will not appear in the final report.
                    </div>
                    
                    <?php echo  $this->Form->control('scientist_notes', [
                        'type' => 'textarea',
                        'rows' => 4,
                        'class' => 'form-control',
                        'label' => ['text' => 'Scientist Notes', 'class' => 'form-label fw-semibold'],
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-light py-3">
                    <h6 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-cog me-2 text-success"></i>Report Settings
                    </h6>
                </div>
                <div class="card-body bg-white">
                    <!-- Status Selection -->
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-light border-0 py-3">
                    <h6 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-route me-2 text-warning"></i>Workflow Progress
                    </h6>
                </div>
                <div class="card-body p-3">
                    ...
                    <div class="mt-3 p-3 bg-light rounded">
                        <div class="d-flex align-items-center">
                            ...
                            <span class="small">
                                <strong>Current Stage:</strong> You are performing the scientific review step. 
                                This report will proceed to medical approval after completion.
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-light py-3">
                    <h6 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-book-open me-2 text-success"></i>Report Guidelines
                    </h6>
                </div>
                <div class="card-body bg-white">
                    <div class="small">
            ...
            <div class="card border-0 shadow">
                <div class="card-header bg-light py-3">
                    <h6 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-chart-bar me-2 text-success"></i>Report Stats
                    </h6>
                </div>
                <div class="card-body bg-white">
