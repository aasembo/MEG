    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-light py-3">
                    <h5 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-file-medical-alt me-2 text-success"></i>Report Information
                    </h5>
                </div>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-light py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-bold text-dark">
                            <i class="fas fa-file-alt me-2 text-success"></i>MEG Report Content
                        </h5>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-warning bg-opacity-10 py-3">
                    <h5 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-sticky-note me-2 text-warning"></i>Internal Scientist Notes
                    </h5>
                </div>
                <div class="card-body bg-white">
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-light py-3">
                    <h6 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-chart-line me-2 text-success"></i>Report Status
                    </h6>
                </div>
                <div class="card-body bg-white">
            ...
            <div class="card border-0 shadow">
                <div class="card-header bg-light py-3">
                    <h6 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-file-export me-2 text-success"></i>Export Options
                    </h6>
                </div>
                <div class="card-body bg-white">
                    <div class="d-grid gap-2">
