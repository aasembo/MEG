            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="mb-2 fw-bold">
                        <i class="fas fa-file-medical-alt me-2"></i>Medical Report #<?= h($report->id) ?>
                    </h2>
                    <p class="mb-0">
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless table-sm">
                                <tr>
                                    ...
                                    <td><span class="badge bg-danger"><?= h($report->id) ?></span></td>
                                </tr>
                                <tr>
                ...
                <div class="card-body bg-white">
                    ...
                    <div class="small">
                        <div class="d-flex align-items-center mb-2">
                            <div class="me-2">
                                <i class="fas fa-circle text-<?= $report->status === 'pending' ? 'danger' : 'danger' ?>"></i>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <div class="me-2">
                                <i class="fas fa-circle text-<?= $report->status === 'reviewed' ? 'danger' : ($report->status === 'approved' ? 'danger' : 'muted') ?>"></i>
                            </div>
                            <div class="<?= $report->status === 'reviewed' ? 'fw-semibold' : ($report->status === 'approved' ? 'text-danger' : 'text-muted') ?>">
                                Under Review
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="me-2">
                                <i class="fas fa-circle text-<?= $report->status === 'approved' ? 'danger' : 'muted' ?>"></i>
                            </div>
                            <div class="<?= $report->status === 'approved' ? 'fw-semibold text-danger' : 'text-muted' ?>">
                                Approved & Final
                            </div>
                        </div>
                    </div>
