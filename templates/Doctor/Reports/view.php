...
$this->assign('title', 'Medical Report #' . $report->id);
?>
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h2 class="mb-2 fw-bold">
                        <i class="fas fa-file-medical-alt me-2"></i>Medical Report #<?php echo  h($report->id) ?>
                    </h2>
                    <p class="mb-0">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-light py-3">
                    <h5 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-file-medical-alt me-2 text-danger"></i>Report Information
                    </h5>
                </div>
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless table-sm">
                                <tr>
                                    ...
                                    <td><span class="badge bg-danger"><?php echo  h($report->id) ?></span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if (isset($report->hospital)): ?>
                                            <i class="fas fa-hospital me-1 text-danger"></i>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-light py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-bold text-dark">
                            <i class="fas fa-file-alt me-2 text-danger"></i>MEG Report Content
                        </h5>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-warning bg-opacity-10 py-3">
                    <h5 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-sticky-note me-2 text-warning"></i>Internal Doctor Notes
                    </h5>
                </div>
                <div class="card-body bg-white">
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body bg-white">
                    <div class="d-grid gap-2">
                        <?php echo  $this->Html->link(
                            ...
                            ['action' => 'edit', $report->id],
                            ['class' => 'btn btn-danger d-flex align-items-center justify-content-center', 'escape' => false]
                        ); ?>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-light py-3">
                    <h6 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-chart-line me-2 text-danger"></i>Report Status
                    </h6>
                </div>
                <div class="card-body bg-white">
                    ...
                    <div class="small">
                        <div class="d-flex align-items-center mb-2">
                            <div class="me-2">
                                <i class="fas fa-circle text-<?php echo  $report->status === 'pending' ? 'danger' : 'danger' ?>"></i>
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <div class="me-2">
                                <i class="fas fa-circle text-<?php echo  $report->status === 'reviewed' ? 'danger' : ($report->status === 'approved' ? 'danger' : 'muted') ?>"></i>
                            </div>
                            <div class="<?php echo  $report->status === 'reviewed' ? 'fw-semibold' : ($report->status === 'approved' ? 'text-danger' : 'text-muted') ?>">
                                Under Review
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="me-2">
                                <i class="fas fa-circle text-<?php echo  $report->status === 'approved' ? 'danger' : 'muted' ?>"></i>
                            </div>
                            <div class="<?php echo  $report->status === 'approved' ? 'fw-semibold text-danger' : 'text-muted' ?>">
                                Approved & Final
                            </div>
                        </div>
                    </div>
            ...
            <div class="card border-0 shadow mb-4">
                <div class="card-header bg-light py-3">
                    <h6 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-chart-bar me-2 text-danger"></i>Report Stats
                    </h6>
                </div>
                <div class="card-body bg-white">
            ...
            <div class="card border-0 shadow">
                <div class="card-header bg-light py-3">
                    <h6 class="mb-0 fw-bold text-dark">
                        <i class="fas fa-file-export me-2 text-danger"></i>Export Options
                    </h6>
                </div>
                <div class="card-body bg-white">
                    <div class="d-grid gap-2">
